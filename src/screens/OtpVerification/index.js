    ...
    const renderOtpView = useCallback(() => {
        return (
            <View style={style.instructionView}>
                <Text style={style.instructionText}>{t("otpverificationscreen.instruction1")}</Text>
                <Text>{`\n`}</Text>
                <Text style={style.instructionText}>{t("otpverificationscreen.instruction2")} + 1 235 256 2852</Text>
                <OTPInputView
                ...
                <View style={style.bottomView}>
                    <Button style={{}} isgradient={true} onClick={() => { setIsvalidate(!isvalidate) }} gradient={gradients.primary} name={t("otpverificationscreen.btnText")} />
                </View>
            </View>
        )
        ...
        <Block>
            ...
            <View style={style.container}>
                <ScrollView style={style.cardDetailsView} contentContainerStyle={style.containerView}>
                    ...
                    <Text style={style.haventText}>{t("otpverificationscreen.haventreceive")}  <Text onPress={() => { }} style={style.resendText}>{t("otpverificationscreen.resend")}</Text></Text>
                    <Text>{`\n`}</Text>
